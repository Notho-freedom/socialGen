...
import { ImageCatalog } from "@/components/image-catalog"
            ...
            <Card className="transition-all duration-300 hover:shadow-lg">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  {currentPlatform && (
                    <Badge variant="outline" className={`${currentPlatform.color} text-white`}>
                      {currentPlatform.name}
                    </Badge>
                  )}
                </CardTitle>
                <CardDescription>
                  Aperçu de votre post tel qu'il apparaîtra sur la plateforme sélectionnée
                </CardDescription>
              </CardHeader>
              <CardContent>
